...
user_content_matrix.write.mode("overwrite").parquet(
    "s3://streamify-bucket-2026/processed-data/user_content_matrix/"
)

content_stats.write.mode("overwrite").parquet(
    "s3://streamify-bucket-2026/processed-data/content_stats/"
)

user_features.write.mode("overwrite").parquet(
    "s3://streamify-bucket-2026/processed-data/user_features/"
)
